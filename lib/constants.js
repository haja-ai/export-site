...
export const SITE = {
  ...
  certifications: ['Saudi SFDA Medical Device Marketing Authorization (documented)', 'Other market documents available on request'],
};
...
export const stats = [
  { label: 'B2B', value: 'Export Focus' },
  { label: 'MiniRedone Models', value: 10, suffix: '', display: 'numeric' },
  { label: 'B2B', value: 'Export Focus', display: 'text' },
  { label: 'Documents', value: 'On Request', display: 'text' },
];
...
export const advantages = [
  ...
  {
    title: 'Documented Quality & Market Support',
    desc: 'Request the exact compliance documents, scope, and validity for your destination market.',
    icon: 'ShieldCheck',
  },
  {
...
export const companyHighlights = [
  ...
  { label: 'B2B Export', desc: 'Distributor Support' },
...
export const aboutStats = [
  ...
  { label: 'Model Range', value: '10 Models' },
];
