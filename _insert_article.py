#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Insert the charging-time article at TOP of news.js (newest first)."""
import sys

SLUG = "electric-wheelchair-charging-time-comparison-b2b"
ANCHOR = "  // ===== 2026-08-22: Electric Wheelchair for Muscular Dystrophy ====="

ARTICLE = '''  // ===== 2026-08-24: Electric Wheelchair Charging Time Comparison =====
  {
    slug: 'electric-wheelchair-charging-time-comparison-b2b',
...
with open("lib/news.js", "r", encoding="utf-8", newline="") as f:
    src = f.read()

assert SLUG not in src, "SLUG ALREADY EXISTS — abort"
assert ANCHOR in src, "ANCHOR NOT FOUND — abort"

new_src = src.replace(ANCHOR, ARTICLE + ANCHOR, 1)
with open("lib/news.js", "w", encoding="utf-8", newline="") as f:
    f.write(new_src)
