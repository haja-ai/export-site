            ...
            <FadeIn className="lg:col-span-2 space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-1">
                  {['MiniRedone-I', 'MiniRedone-I-W', 'MiniRedone-I-B&R', 'MiniRedone-II', 'MiniRedone-III', 'MiniRedone-IV', 'MiniRedone-V'].map((name) => {
            ...
            <FadeIn delay={0.15} className="lg:col-span-3">
              <div className="bg-white rounded-2xl border border-gray-200 p-6 lg:p-8">
                ...
                <p className="text-sm text-gray-500 mb-6">
                  Fill out the form below and we&apos;ll get back to you with a customized quotation and
